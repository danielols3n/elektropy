...
print("wheatstone_balance_resistance(1000, 1000, 1000) ->", wheatstone_balance_resistance(1000, 1000, 1000))
print("wheatstone_balance_voltage(1000, 1000, 1000) ->", wheatstone_balance_voltage(1000, 1000, 1000))
print("wheatstone_resistance(1000, 1000, 1000, 5.0, 0.0) ->", wheatstone_resistance(1000, 1000, 1000, 5.0, 0.0))
print("wheatstone_voltage(1000, 1000, 1000, 1000, 5.0) ->", wheatstone_voltage(1000, 1000, 1000, 1000, 5.0))